...
Page.Content = function PageContent({ children }: PropsWithChildren) {
  return (
    <main className="flex flex-grow pt-4">
      {children}
    </main>
  );
};
...
function ExpoLogoBig({ className, ...props }: HTMLAttributes<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 71 20" fill="none" role="img" className={cn('icon-md text-default', className)} {...props}>
      <path
...
function ExpoLogoSmall({ className, ...props }: HTMLAttributes<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 20 20" fill="none" role="img" className={cn('icon-md text-default', className)} {...props}>
      <path
