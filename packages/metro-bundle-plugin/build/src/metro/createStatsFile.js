...
exports.addStatsEntry = exports.createStatsFile = exports.getStatsMetdata = exports.getStatsPath = void 0;
...
function addStatsEntry(projectRoot, stats) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fs_1.default.promises.appendFile(getStatsPath(projectRoot), JSON.stringify(stats) + '\n')];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
