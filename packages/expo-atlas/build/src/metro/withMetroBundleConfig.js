...
var serializeStatsFile_1 = require("./serializeStatsFile");
function withMetroBundleConfig(config) {
    ...
    (0, serializeStatsFile_1.createStatsFile)(projectRoot);
    // @ts-expect-error
    config.serializer.customSerializer = function (entryPoint, preModules, graph, options) {
        (0, serializeStatsFile_1.addStatsEntry)(projectRoot, (0, convertGraphToStats_1.convertGraphToStats)({ projectRoot: projectRoot, entryPoint: entryPoint, preModules: preModules, graph: graph, options: options }));
